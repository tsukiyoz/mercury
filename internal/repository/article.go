...
func NewCachedArticleRepository(articleDao articleDao.ArticleDAO, articleCache cache.ArticleCache, userRepo UserRepository, l logger.Logger) ArticleRepository {
