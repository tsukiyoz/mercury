...
const (
	...
	FollowService_GetRelation_FullMethodName  = "/follow.v1.FollowService/GetRelation"
	FollowService_GetStatics_FullMethodName   = "/follow.v1.FollowService/GetStatics"
)
...
func (c *followServiceClient) GetRelation(ctx context.Context, in *GetRelationRequest, opts ...grpc.CallOption) (*GetRelationResponse, error) {
	...
	err := c.cc.Invoke(ctx, FollowService_GetRelation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *followServiceClient) GetStatics(ctx context.Context, in *GetStaticsRequest, opts ...grpc.CallOption) (*GetStaticsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetStaticsResponse)
	err := c.cc.Invoke(ctx, FollowService_GetStatics_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedFollowServiceServer) GetStatics(context.Context, *GetStaticsRequest) (*GetStaticsResponse, error) {
...
func _FollowService_GetStatics_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetStaticsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FollowServiceServer).GetStatics(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: FollowService_GetStatics_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FollowServiceServer).GetStatics(ctx, req.(*GetStaticsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var FollowService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _FollowService_GetStatics_Handler,
		},
	},
