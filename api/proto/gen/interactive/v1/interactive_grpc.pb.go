...
const (
	...
	InteractiveService_Favorite_FullMethodName       = "/interactive.v1.InteractiveService/Favorite"
	InteractiveService_CancelFavorite_FullMethodName = "/interactive.v1.InteractiveService/CancelFavorite"
...
type InteractiveServiceClient interface {
	...
	CancelFavorite(ctx context.Context, in *CancelFavoriteRequest, opts ...grpc.CallOption) (*CancelFavoriteResponse, error)
...
func (c *interactiveServiceClient) Favorite(ctx context.Context, in *FavoriteRequest, opts ...grpc.CallOption) (*FavoriteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FavoriteResponse)
	err := c.cc.Invoke(ctx, InteractiveService_Favorite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *interactiveServiceClient) CancelFavorite(ctx context.Context, in *CancelFavoriteRequest, opts ...grpc.CallOption) (*CancelFavoriteResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CancelFavoriteResponse)
	err := c.cc.Invoke(ctx, InteractiveService_CancelFavorite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type InteractiveServiceServer interface {
	...
	CancelFavorite(context.Context, *CancelFavoriteRequest) (*CancelFavoriteResponse, error)
...
func (UnimplementedInteractiveServiceServer) Favorite(context.Context, *FavoriteRequest) (*FavoriteResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Favorite not implemented")
}
func (UnimplementedInteractiveServiceServer) CancelFavorite(context.Context, *CancelFavoriteRequest) (*CancelFavoriteResponse, error) {
...
func _InteractiveService_Favorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FavoriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).Favorite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_Favorite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).Favorite(ctx, req.(*FavoriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _InteractiveService_CancelFavorite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CancelFavoriteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(InteractiveServiceServer).CancelFavorite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: InteractiveService_CancelFavorite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(InteractiveServiceServer).CancelFavorite(ctx, req.(*CancelFavoriteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var InteractiveService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Favorite",
			Handler:    _InteractiveService_Favorite_Handler,
		},
		{
			MethodName: "CancelFavorite",
			Handler:    _InteractiveService_CancelFavorite_Handler,
		},
		{
			MethodName: "Get",
