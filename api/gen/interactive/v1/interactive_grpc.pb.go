...
func (c *interactiveServiceClient) Favorite(ctx context.Context, in *FavoriteRequest, opts ...grpc.CallOption) (*FavoriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, InteractiveService_Favorite_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *interactiveServiceClient) CancelFavorite(ctx context.Context, in *CancelFavoriteRequest, opts ...grpc.CallOption) (*CancelFavoriteResponse, error) {
	...
	err := c.cc.Invoke(ctx, InteractiveService_CancelFavorite_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
