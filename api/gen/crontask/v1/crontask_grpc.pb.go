...
func (c *cronTaskServiceClient) Preempt(ctx context.Context, in *PreemptRequest, opts ...grpc.CallOption) (*PreemptResponse, error) {
	...
	err := c.cc.Invoke(ctx, CronTaskService_Preempt_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cronTaskServiceClient) ResetNextTime(ctx context.Context, in *ResetNextTimeRequest, opts ...grpc.CallOption) (*ResetNextTimeResponse, error) {
	...
	err := c.cc.Invoke(ctx, CronTaskService_ResetNextTime_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *cronTaskServiceClient) AddTask(ctx context.Context, in *AddTaskRequest, opts ...grpc.CallOption) (*AddTaskResponse, error) {
	...
	err := c.cc.Invoke(ctx, CronTaskService_AddTask_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedCronTaskServiceServer must be embedded to have
...
func (UnimplementedCronTaskServiceServer) testEmbeddedByValue()                         {}
...
func RegisterCronTaskServiceServer(s grpc.ServiceRegistrar, srv CronTaskServiceServer) {
	// If the following call pancis, it indicates UnimplementedCronTaskServiceServer was
