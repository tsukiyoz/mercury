...
type WechatPaymentServiceClient interface {
	NativePrePay(ctx context.Context, in *NativePrePayRequest, opts ...grpc.CallOption) (*NativePrePayResponse, error)
...
func (c *wechatPaymentServiceClient) NativePrePay(ctx context.Context, in *NativePrePayRequest, opts ...grpc.CallOption) (*NativePrePayResponse, error) {
...
func (c *wechatPaymentServiceClient) RefundPayment(ctx context.Context, in *RefundPaymentRequest, opts ...grpc.CallOption) (*RefundPaymentResponse, error) {
	...
	err := c.cc.Invoke(ctx, WechatPaymentService_RefundPayment_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type WechatPaymentServiceServer interface {
	NativePrePay(context.Context, *NativePrePayRequest) (*NativePrePayResponse, error)
...
func (UnimplementedWechatPaymentServiceServer) NativePrePay(context.Context, *NativePrePayRequest) (*NativePrePayResponse, error) {
...
func _WechatPaymentService_NativePrePay_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(WechatPaymentServiceServer).NativePrePay(ctx, req.(*NativePrePayRequest))
	}
