...
const file_echo_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"echo.proto\x12\x12grpc.examples.echo\"'\n" +
	...
	"\x1aBidirectionalStreamingEcho\x12\x1f.grpc.examples.echo.EchoRequest\x1a .grpc.examples.echo.EchoResponse\"\x00(\x010\x01B0Z.mercury/pkg/grpcx/examples/features/proto/echob\x06proto3"
